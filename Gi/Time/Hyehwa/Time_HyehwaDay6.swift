...
struct Time_HyehwaDay6: View {
    ...
    func getPreviousDayOfWeek(currentDate: Date) -> String {
        ...
        let previousDate = calendar.date(byAdding: .day, value: +6, to: currentDate)!
...
struct Time_HyehwaDay6_Previews: PreviewProvider {
    static var previews: some View {
        Time_HyehwaDay6(currentDate: .constant(Date())).environmentObject(TimeDataFetcher())
    }
}
