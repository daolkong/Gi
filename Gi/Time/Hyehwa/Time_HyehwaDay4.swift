//
//  Time_HyehwaDay4.swift
//  Gi
//
//  Created by Daol on 2023/07/08.
//

import SwiftUI

struct Time_HyehwaDay4: View {
    ...
    func getPreviousDayOfWeek(currentDate: Date) -> String {
        ...
        let previousDate = calendar.date(byAdding: .day, value: +4, to: currentDate)!
...
struct Time_HyehwaDay4_Previews: PreviewProvider {
    static var previews: some View {
        Time_HyehwaDay4(currentDate: .constant(Date())).environmentObject(TimeDataFetcher())
    }
}
