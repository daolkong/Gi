...
struct Time_Alpha1Day4_Previews: PreviewProvider {
    static var previews: some View {
        Time_Alpha1Day4(currentDate: .constant(Date())).environmentObject(TimeDataFetcher())
    }
}
