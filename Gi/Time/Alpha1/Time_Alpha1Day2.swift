...
struct Time_Alpha1Day2: View {
    ...
    func getPreviousDayOfWeek(currentDate: Date) -> String {
        ...
        let previousDate = calendar.date(byAdding: .day, value: +2, to: currentDate)!
...
struct Time_Alpha1Day2_Previews: PreviewProvider {
    static var previews: some View {
        Time_Alpha1Day2(currentDate: .constant(Date())).environmentObject(TimeDataFetcher())
    }
}
