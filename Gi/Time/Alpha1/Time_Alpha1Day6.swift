...
struct Time_Alpha1Day6_Previews: PreviewProvider {
    static var previews: some View {
        Time_Alpha1Day6(currentDate: .constant(Date())).environmentObject(TimeDataFetcher())
    }
}
