...
struct Time_Alpha1Day5_Previews: PreviewProvider {
    static var previews: some View {
        Time_Alpha1Day5(currentDate: .constant(Date())).environmentObject(TimeDataFetcher())
    }
}
