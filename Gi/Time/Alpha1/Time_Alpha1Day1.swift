...
struct Time_Alpha1Day1_Previews: PreviewProvider {
    static var previews: some View {
        Time_Alpha1Day1(currentDate: .constant(Date())).environmentObject(TimeDataFetcher())
    }
}
